...
function check_problems_sytax_restrictions ( statements_arr ) {
	...
	switch ( prob_id ) {
		...
		case 4:
			if ( ! E_Prob_4_res ( statements_arr ) ) return false;
		break;
		...
		case 6:
			if ( ! A_Prob_1_res ( statements_arr ) ) return false;
		break;

		case 8:
			if ( ! A_Prob_3_res ( statements_arr ) ) return false;
		break;

		case 9:
			if ( ! A_Prob_4_res ( statements_arr ) ) return false;
